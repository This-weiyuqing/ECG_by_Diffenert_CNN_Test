...
#PATH of this test
Project_PATH = "../Number-Of-Conv-Structure/Fifteen/"
#PICTUREPATH= Project_PATH + "picture/"
log_dir = Project_PATH + "logs/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
model_Path_one = Project_PATH  + "model/ecg_model_fifteen_conv.h5"
...
def CNN_model_level_one():
    leavlOneModel = tf.keras.models.Sequential([
        ...
        tf.keras.layers.Conv1D(filters=15, kernel_size=15, strides=2, padding='same', activation='relu'),
