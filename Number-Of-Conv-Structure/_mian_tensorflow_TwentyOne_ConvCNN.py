...
from utils_twentyone_of_ConvCNN import loadData, plot_history_tf, plot_heat_map

#from ECG_read_weiyuqing_without_wfdb import ECGDATAPATH
#PATH of this test
Project_PATH = "../Number-Of-Conv-Structure/TwentyOne/"
#PICTUREPATH= Project_PATH + "picture/"
log_dir = Project_PATH + "logs/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
model_Path_one = Project_PATH  + "model/ecg_model_twentyone_conv.h5"
...
def CNN_model_level_one():
    leavlOneModel = tf.keras.models.Sequential([
        ...
        tf.keras.layers.Conv1D(filters=15, kernel_size=21, strides=2, padding='same', activation='relu'),
